...
export default function TaskListReduce({tasks, onChangeTask, onDeleteTask, setTasks}) {
            ...
            <tbody>
              {tasks.map((task, index) => (
                <tr key={index}>
                  ...
                  <td> 
                    <button onClick={()=>onChangeTask({ ...task, done: !task.done })}> {task.done?'Edit':'Save' }</button>
